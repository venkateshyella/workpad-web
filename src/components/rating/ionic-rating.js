...
(function () {
	angular.module('ionic.rating', [])
		...
		return {
			...
			template: '<ul class="rating" ng-keydown="onKeydown($event)" layout="row">' +
			'<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)">' +
			'<i class="icon" ng-class="value === undefined ? (r === 1 ? \'icon-star\' : (r === 2 ? \'icon-star-half\' : \'icon-star-outline\')) : (value > $index ? \'icon-star\' : \'icon-star-outline\')"></i>' +
			'</li>' +
			'</ul>',
			replace: true,
