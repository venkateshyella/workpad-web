...
(function () {
	...
	angular.module('app')
		.service('JobAdvertisement', [
			'$q', '$timeout', 'DataProvider',
			'Connect', 'URL', 'Lang',
			JobAdvertisementService
		])
		.factory('JobAdvertisementFactory', [JobAdvertisementFactory])
	;

	function JobAdvertisementService($q, $timeout, DataProvider, Connect, URL, Lang) {
	...
	function JobAdvertisementFactory() {
		return {
			GroupAdvertisement: JobAdvertisement
		}
	}
